...
package org.igniterealtime.xiff.data.stream
{
	...
	public class IBBCloseExtensionTest
	{
		...
		public function testElement():void
		{
			...
			var elementName:String = "close";

			var ext:IBBCloseExtension = new IBBCloseExtension();
		...
		{
			var incoming:XML = <close xmlns='http://jabber.org/protocol/ibb' sid='i781hf64'/>;
