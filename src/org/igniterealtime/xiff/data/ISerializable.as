...
package org.igniterealtime.xiff.data
{
	...
	public interface ISerializable
	{
		 ...
		 * If the instance also implements INodeProxy, then the parent should be verified 
		 * against the parent XMLNode passed to determine if the serialization is in the same namespace.
		 *
