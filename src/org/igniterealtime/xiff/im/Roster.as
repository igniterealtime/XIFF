...
package org.igniterealtime.xiff.im
{
	...
	public class Roster extends ArrayCollection
	{
		 ...
		 *
		 * @param	id The JID (unescaped) of the contact to add
		...
		public function addContact( id:UnescapedJID, displayName:String, groupName:String = null, requestSubscription:Boolean = true ):void
		{
			...
			var iq:IQ = new IQ( null, IQ.TYPE_SET, XMPPStanza.generateID( "add_user_" ),
									callbackMethod, callbackObj );
			var ext:RosterExtension = new RosterExtension( iq.node );
		...
		public function fetchRoster():void
		{
			...
			iq.addExtension( new RosterExtension( iq.node ) );
			_connection.send( iq );
		}
